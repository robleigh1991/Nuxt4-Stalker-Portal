import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, inject, ref, useSlots, computed, mergeProps, unref, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, createVNode, toRef, provide, toValue, resolveDynamicComponent, watch, mergeModels, useModel, createTextVNode, Fragment, renderList, hasInjectionContext, isRef, onServerPrefetch, getCurrentInstance, nextTick, useAttrs, useTemplateRef, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, Suspense, createApp, useId, shallowReactive, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, m as parseQuery, o as defu, q as klona, t as defuFn, v as isEqual, w as hasProtocol, x as isScriptProtocol, y as joinURL, z as withQuery, A as sanitizeStatusCode, B as withTrailingSlash, C as withoutTrailingSlash, D as getContext, c as createError$1, E as withLeadingSlash, F as parseURL, $ as $fetch$1, G as baseURL, H as createHooks, I as executeAsync, J as toRouteMatcher, K as createRouter$1, L as encodeParam, M as encodePath } from '../_/nitro.mjs';
import { setActivePinia, createPinia, shouldHydrate } from 'pinia';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import colors from 'tailwindcss/colors';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderStyle, ssrRenderList, ssrRenderAttrs, ssrRenderSuspense } from 'vue/server-renderer';
import { useForwardProps, Primitive, Slot, useForwardPropsEmits, ProgressRoot, ProgressIndicator, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose } from 'reka-ui';
import { useDebounceFn, reactivePick, reactiveOmit, createSharedComposable } from '@vueuse/core';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CjpFXmly.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-YopleOmW.mjs')
  },
  {
    name: "index-new",
    path: "/index-new",
    component: () => import('./index-new-DaDB0AqC.mjs')
  },
  {
    name: "index-old",
    path: "/index-old",
    component: () => import('./index-old-Ch3TrR65.mjs')
  },
  {
    name: "dashboard copy",
    path: "/dashboard%20copy",
    component: () => import('./dashboard copy-CV0-YObR.mjs')
  }
];
...
const ipxRuntime$S4yI2Onykyjl3Me6lIacCna1P6jroKwW4haTdI_457YGM = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$S4yI2Onykyjl3Me6lIacCna1P6jroKwW4haTdI_457YGM, defaults: {} }
  }
};
...
const ImageComponent = Object.assign(_sfc_main$e, { __name: "NuxtImg" });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-1KGDkbyh.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C-qfw1TA.mjs'));
...
export { __nuxt_component_0$2 as _, useToast as a, _sfc_main$9 as b, __nuxt_component_0$1 as c, useLocale as d, entry_default as default, useAppConfig as e, usePortal as f, get as g, useFormField as h, useFieldGroup as i, useComponentIcons as j, isArrayOfArray as k, compare as l, _sfc_main$f as m, navigateTo as n, _sfc_main$c as o, _sfc_main$d as p, looseToNumber as q, getDisplayValue as r, _sfc_main$8 as s, tv as t, useHead as u, useRoute as v, getSlotChildrenText as w, _sfc_main$a as x, useState as y };
